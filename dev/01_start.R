...
golem::fill_desc(
  ...
  author_email = "dnl2001@stern.nyu.edu", # Your Email
...
usethis::use_mit_license( copyright_holder = "David Lucey" )  # You can set another license here
...
golem::use_favicon("/Users/davidlucey/Desktop/David/Projects/favicon.ico")
